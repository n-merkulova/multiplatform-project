 ...
 */
export type AppearanceSchemeType =
  | 'vkcom_light'
  | 'vkcom_dark'
  | 'space_gray'
  | 'bright_light';
...
export type RequestPropsMap = {
  ...
  VKWebAppCallAPIMethod: {
    method: string;
    params: Record<'access_token' | 'v', string> &
...
> &
  ...
  EventReceiveNames<
    'VKWebAppAudioPause',
    'VKWebAppAudioPauseResult',
    'VKWebAppAudioPauseFailed'
  > &
  EventReceiveNames<
    'VKWebAppGetEmail',
  ...
  EventReceiveNames<
    'VKWebAppAddToMenu',
    'VKWebAppAddToMenuResult',
    'VKWebAppAddToMenuFailed'
  > &
  EventReceiveNames<
    'VKWebAppOpenCodeReader',
  ...
  EventReceiveNames<
    'VKWebAppShowSurvey',
    'VKWebAppShowSurveyResult',
    'VKWebAppShowSurveyFailed'
  > &
  EventReceiveNames<
 ...
 */
export type AnyRequestOnlyMethodName = Exclude<
 ...
 */
export type AnyReceiveOnlyMethodName = Exclude<
  AnyReceiveMethodName,
  AnyRequestMethodName
>;
...
export type AnyRequestMethodNameWithProps = {
  [K in keyof RequestPropsMap]: keyof RequestPropsMap[K] extends never
    ? never
    : K;
 ...
 */
export type AnyFailedResponseEventName =
  FailedResponseEventName<AnyRequestMethodName>;

/**
 * Any result response event method name.
 */
export type AnyResultResponseEventName =
  ResultResponseEventName<AnyRequestMethodName>;
...
export type RequestProps<
  M extends AnyRequestMethodName = AnyRequestMethodName,
> = RequestPropsMap[M];
 ...
 */
export type VKBridgeErrorEvent<M extends AnyReceiveMethodName> =
  VKBridgeEventBase<
...
export type VKBridgeIOEvent<M extends AnyIOMethodName> = {
  [K in M]: VKBridgeEventBase<
    ResultResponseEventName<K>,
    ReceiveData<K> & RequestIdProp
  >;
}[M];
 ...
 */
export type VKBridgeSubscribeHandler = (
